                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control " type="text" id="inp_nik" name="inp_nik" placeholder="Nomor Induk Kependudukan">
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-5">
                                        <select class="form-select select2" id="inp_kec" name="inp_kec">
                                            ...
                                            <?=
                                            "<option value='" . $datawarga->id_kec . "'>" . $datawarga->nama_kec . "</option>" ?>
