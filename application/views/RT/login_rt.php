            ...
            <div class="row">
                <div class="col-12">
                    <div class="login-card">
                        <form class="theme-form login-form" method="POST" action="C_Auth">
                            <h4>Login RT</h4>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group"><span class="input-group-text"><i class="icon-user"></i></span>
                                    <input class="form-control" type="text" name="NIK" id="NIK" placeholder="NIK/Username" value="<?= set_value('NIK'); ?>">
                                </div>
