                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel">Keselahan Data ???</h5>
                                            <button class="btn-close" type="button" data-bs-dismiss="modal" aria-label="Close"></button>
                                        </div>
                                        <div class="modal-body">
                                            Jika anda merasa data anda tidak benar. lakukan pelaporan pada menu Lapor dan pilih kategorinya "Infrastruktur" atau anda dapat mengunjungin <a class="txt-secondary" href="<?= base_url('Warga/C_form_pengaduan'); ?>">link ini</a>
                                        </div>
